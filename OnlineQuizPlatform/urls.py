...
# blogs app
    path('blog/', blogviews.HomeView.as_view(), name='blog'),
    #bpath('about/', views.about, name='blogapp-about'),
    path('<str:username>/', blogviews.UserPostView.as_view(), name='users_blog'),
    path('post/<int:pk>/', blogviews.PostDetails.as_view(), name='blog_post_detail'),
    path('post/create/', blogviews.CreatePost.as_view(), name='blog-post-create'),
    path('post/<int:pk>/update', blogviews.PostUpdate.as_view(), name='blog-post-update'),
    path('post/<int:pk>/delete', blogviews.PostDelete.as_view(), name='blog-post-delete'),
    path('post/<int:pk>/comment/', blogviews.add_comment, name='add_comments'),
    ...
    path('comment/<int:pk>/edit/', blogviews.comment_update, name='comment_edit'),
